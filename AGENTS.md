...
- `src/components/AdminSelect.tsx` - Shared Partners-aligned custom listbox for every Admin dropdown. Use this component instead of native `<select>` elements so opened option panels, keyboard navigation, disabled states, and focus behavior stay consistent across browsers.
