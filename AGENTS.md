...
- `src/lib/service-expansion-requests.ts` and `src/components/ServiceExpansionRequestsTab.tsx` - Figma-backed service-expansion demand dashboard with region/clinic views, aggregate metrics, server search/pagination, top-region ranking, and the clinic requester-history dialog.
