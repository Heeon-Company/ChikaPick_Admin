...
- `src/components/InformationUploadTab.tsx` - UI-only Figma `6916:53548` Dentalpedia upload form. It owns only local presentation state for video/article selection, thumbnail picking, fields, category, visibility, and form buttons; persistence remains disconnected until an Admin API contract is defined.
